    ...
    <div className="space-y-6">
      <div className="space-y-2">
        <p className="text-large">
          We appreciate having you as a participant. This survey is about exploring your cognitive traits and how they
      ...
      <Card className="space-y-2 p-4 bg-transparent">
        ...
        <ul className="list-disc list-inside pl-4">
          ...
          <li>
            <span className="font-medium">Cognitive Assessment:</span> Answer a series of questions designed to uncover
            key cognitive traits and patterns.
          </li>
          <li>
            <span className="font-medium">Your Results:</span> Get a summary of your cognitive profile based on your
            responses.
          </li>
          <li>
      ...
      <Card className="space-y-2 p-4 bg-transparent">
        ...
        <ul className="list-disc list-inside pl-4">
          <li>
            <span className="font-medium">Microphone Access:</span> You'll need to grant microphone access for voice
            interaction.
          </li>
          <li>
            <span className="font-medium">Optimal Environment:</span> Choose a quiet space free from distractions to
      ...
      <Card className="space-y-2 p-4 bg-transparent">
        ...
        <p>
          Completing the survey will take approximately <span className="font-medium">20-30 minutes</span>. Your time
